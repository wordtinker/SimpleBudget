...
class Ui_manageTransaction(object):
    def setupUi(self, manageTransaction):
        ...
        self.label_3 = QtWidgets.QLabel(manageTransaction)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_2.addWidget(self.label_3)
        self.accountBox = QtWidgets.QComboBox(manageTransaction)
        self.accountBox.setObjectName("accountBox")
        self.horizontalLayout_2.addWidget(self.accountBox)
    ...
    def retranslateUi(self, manageTransaction):
        ...
        self.label_3.setText(_translate("manageTransaction", "Account"))
        self.label_5.setText(_translate("manageTransaction", "IInfo"))
